      ...
      <div className="flex justify-between items-center px-4 py-2">
        ...
        <div className="flex items-center gap-1">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.99967 11.513L12.1197 13.9997L11.0263 9.31301L14.6663 6.15967L9.87301 5.74634L7.99967 1.33301L6.12634 5.74634L1.33301 6.15967L4.96634 9.31301L3.87967 13.9997L7.99967 11.513Z" fill="white"/>
          </svg>
  ...
  return (
    <nav className="flex w-full px-20 py-6 justify-between items-center bg-chill-background relative z-50">
      ...
      <div className="relative">
        ...
        >
          <div className="w-10 h-10 rounded-full bg-gray-600 bg-cover bg-center" 
               style={{backgroundImage: 'url(https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop&crop=face)'}}
          ></div>
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.645 10.0215L14 15.3648L19.355 10.0215L21 11.6665L14 18.6665L7 11.6665L8.645 10.0215Z" fill="white"/>
          </svg>
        </button>
        ...
        {showDropdown && (
          <div className="absolute right-0 top-12 w-[156px] py-1 bg-chill-background rounded border border-chill-border shadow-lg">
            <div className="flex px-3 py-2 items-center gap-1.5 hover:bg-chill-body cursor-pointer">
              ...
              <span className="text-chill-primary text-sm font-medium font-lato">Profil Saya</span>
            </div>
            <div className="flex px-3 py-2 items-center gap-1.5 hover:bg-chill-body cursor-pointer">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 17.27L18.18 21L16.54 13.97L22 9.24L14.81 8.62L12 2L9.19 8.62L2 9.24L7.45 13.97L5.82 21L12 17.27Z" fill="white"/>
              </svg>
              <span className="text-white text-sm font-medium font-lato">Ubah Premium</span>
            </div>
            <div className="flex px-3 py-2 items-center gap-1.5 hover:bg-chill-body cursor-pointer">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-white text-sm font-medium font-lato">Keluar</span>
            </div>
          </div>
        )}
      </div>
    ...
    <div className="flex justify-between items-start">
      ...
      <div className="flex gap-40">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-7">
            <div className="flex flex-col gap-3">
              ...
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Anime</a>
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Britania</a>
            </div>
            <div className="flex flex-col gap-3">
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Drama</a>
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Fantasi Ilmiah & Fantasi</a>
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Kejahatan</a>
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">KDrama</a>
            </div>
            <div className="flex flex-col gap-3">
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Komedi</a>
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Petualangan</a>
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Perang</a>
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Romantis</a>
            </div>
            <div className="flex flex-col gap-3">
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Sains & Alam</a>
              <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Thriller</a>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">FAQ</a>
            <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Kontak Kami</a>
            <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Privasi</a>
            <a href="#" className="text-chill-text-secondary text-base font-medium font-lato hover:text-white">Syarat & Ketentuan</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-chill-background">
      ...
      <ContentSection title="Top Rating Film dan Series Hari ini">
        <ScrollableRow>
          ...
          />
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/7eb4d1a2a148efccdccd99093968f5dcd9316bf0?width=468"
          />
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/5f0fba8aed94e4d02a837c0e8d4fc99247318507?width=468"
          />
          <MovieCard 
          ...
          />
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/1075a485b17cfef0b042216d4e0d0edf57f7893f?width=468"
          />
        </ScrollableRow>
      </ContentSection>
      ...
      <ContentSection title="Film Trending">
        <ScrollableRow>
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/738e71a2903cb2b771583023713598589ba29931?width=468"
          />
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/1e46cd09c2a17d0f651a64b0dffa1ff58a2b7e74?width=468"
          />
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/6d0e52a87b1e30af3ffe0e5d20d78733636fb80d?width=468"
          />
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/790e61077ddb8249825963553e9c65ebaaa01a9f?width=468"
          />
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/88c2d63a30237991ca8d18d8d001158226811595?width=468"
          />
        </ScrollableRow>
      </ContentSection>
      ...
      <ContentSection title="Rilis Baru">
        <ScrollableRow>
          ...
          />
          <MovieCard 
            image="https://api.builder.io/api/v1/image/assets/TEMP/433b69ba411022747be3a778771529d7a7db879e?width=468"
          />
        </ScrollableRow>
      </ContentSection>
