  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(0deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url('https://api.builder.io/api/v1/image/assets/TEMP/617ccc1c367d68e0bca74925bd96aabc389cee2e?width=2880')`
        }}
      />
      
      {/* Login Form */}
      <div className="relative z-10 w-[529px] p-10 flex flex-col items-center gap-9 rounded-2xl bg-chill-background/84 backdrop-blur-md border border-chill-border">
        {/* Logo */}
        ...
        <div className="flex flex-col items-center gap-2">
          <h1 className="text-white text-center text-[32px] font-bold leading-[110%] font-lato">
            Masuk
          </h1>
        ...
        <div className="flex flex-col items-start gap-3 w-full">
          ...
          <div className="flex justify-between items-start w-full">
            ...
            <a 
              href="#" 
              className="text-white text-base font-normal leading-[140%] tracking-[0.2px] font-lato hover:underline"
            >
              Lupa kata sandi?
            </a>
          </div>
        ...
        <div className="flex flex-col justify-center items-center gap-2 w-full">
          ...
          <button className="flex h-[47px] px-5 py-3.5 justify-center items-center gap-5 w-full rounded-3xl border border-chill-border hover:bg-white/5 transition-colors">
            <img 
              src="https://api.builder.io/api/v1/image/assets/TEMP/21315825186a8a75ed932beb8e08f00c74c83243?width=36" 
              alt="Google" 
